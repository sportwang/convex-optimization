...
class l1_square () :
    ...
    def admm_primal (self,x_0) :
        ...
        '''
        plt.figure(figsize=(8,8))
        plt.plot(path,color='red',label ="ADMM_primal")
        plt.legend(loc='upper right')
        '''
        plt.plot(x)
        print 'admm_primal optimal :%f' , path[-1]
        end_time = datetime.now()
        print"used time :",(end_time-start_time).seconds
    ...
    def admm_primal_linear (self,x_0) :
        ...
        '''
        plt.figure(figsize=(8,8))
        plt.plot(path,color='red',label ="ADMM_primal_linear")
        plt.legend(loc='upper right')
        '''
        plt.plot(x)
        print 'admm_primal_linear optimal :%f' ,path[-1]
        end_time = datetime.now()
        print"used time :",(end_time-start_time).seconds
    ...
    def admm_dual (self,x_0) :
        ...
        '''
        plt.plot(x)
        print 'admm_dual optimal :%f' , path[-1]
        end_time = datetime.now()
        print"used time :",(end_time-start_time).seconds
    def admm_alm(self,x) :
        x = x_0
        ...
        '''
        plt.figure(figsize=(8,8))
        plt.plot(path,color='red',label ="ADMM_dual_alm")
        plt.legend(loc='upper right')
        '''
        plt.plot(x)
        print 'admm_alm optimal :%f' , path[-1]
        end_time = datetime.now()
        print"used time :",(end_time-start_time).seconds
